	...
	var vue = new Vue({
		...
		methods:{
			...
			login: function(){
				...
				this.$http.post(url).then(function(response){
					...
					if(flag){
						...
						$.ajax({
							url :"/springmvc/user/page?currentPage="+1+"&username="+vue.s_username,
							type:"post",
							success : function(result){
								vue.users=result.data;
								vue.totalPage = result.totalPage;
			...
			searchUser : function(){
				...
				$.ajax({
					url :"/springmvc/user/page?currentPage="+vue.currentPage+"&username="+vue.s_username,
					type:"post",
					success : function(result){
						vue.users=result.data;
						vue.totalPage = result.totalPage;
...
//						vue.u_password = result.password;
			...
			preBtn:function(){
				$.ajax({
					url :"/springmvc/user/page?currentPage="+(vue.currentPage-1)+"&username="+vue.s_username,
					type:"post",
					success : function(result){
						vue.users=result.data;
						vue.totalPage = result.totalPage;
			...
			nextBtn:function(){
				var currentPage = vue.currentPage+1;
				if(  currentPage >= vue.totalPage){
					currentPage = vue.totalPage;
				}
				$.ajax({
					url :"/springmvc/user/page?currentPage="+currentPage+"&username="+vue.s_username,
					type:"post",
					success : function(result){
						vue.users=result.data;
						vue.totalPage = result.totalPage;
